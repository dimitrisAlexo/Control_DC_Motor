...
hold on;
plot(timeData, obv_positionData);
title('position')

figure
plot(timeData,velocityData);
hold on;
plot(timeData, obv_velocityData);
title('velocity')
...
disp('Disconnect cable from Arduino to Input Power Amplifier and then press enter to stop controller');
